...
const SideListCateWrap = styled.div`
  width: 100%;
  min-width: 130px;
  display: flex;
  flex-wrap: wrap;
...
function SideTagNav({ data, boardTap }: SideTagNavTypes) {
  ...
  const [cateArr, setCateArr] = useState<Array<string>>([]);
